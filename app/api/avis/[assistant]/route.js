      ...
      if (inAssistants) {
        if (correspondance >= matchNumber) {
          ...
          await UserModel.updateOne(
            { _id: user._id, "assistantProjets.projectId": projet._id },
          ...
          await UserModel.updateOne(
            { _id: user._id },
            { $pull: { assistantProjets: { projectId: projet._id } } }
          );
        }
      } else {
        if (correspondance >= matchNumber) {
          ...
          const assistantProjets = { correspondance, projectId: projet._id };
